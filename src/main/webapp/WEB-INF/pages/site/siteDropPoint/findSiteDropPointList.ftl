...
<div class="iframe_header">
    <ul class="iframe_nav">
        <li><a href="#">首页</a> &gt;</li>
        <li><a href="#">基础信息</a> &gt;</li>
        <li class="active">投放点管理</li>
    </ul>
</div>

<div class="iframe_search">
<form method="get" action='${basePath}/siteDropPoint/findSiteDropPointList.do' id="searchForm">
    <table class="s_table">
        <tbody>
            <tr>
            ...
            <tr>
                ...
                <td class="s_label"><a class="btn btn_cc1" id="addsiteDropPoint_button">新增</a></td>
                <td></td>
                <td></td>
...
$(function(){
    ...
    //新增
    $("#addsiteDropPoint_button").on('click',function(){
        var url = "${basePath}/siteDropPoint/showAddSiteDropPoint.do";
        updateDialog = new xDialog(url, {}, {title:"新增投放点信息",width:900});
    });

    //修改
    $("a.editDict").on('click',function(){
        var siteDropPointId = $(this).attr("data");
        var url = "${basePath}/siteDropPoint/showUpdateSiteDropPoint.do?id="+siteDropPointId;
        updateDialog = new xDialog(url, {}, {title:"修改投放点信息",width:900});
    });
