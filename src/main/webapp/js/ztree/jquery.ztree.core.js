...
(function($){
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            makeDOMNodeIcon: function(html, setting, node , num) {
                ...
                html.push("<span id='", node.tId, consts.id.ICON,
                    ...
                    "'>",name,"</span>" +
                    "<span class='node_num'>" , (typeof node.num == 'number')? "(" + node.num + ")" :" " ,"</span>");
        ...
        init: function(obj, zSetting, zNodes) {
            ...
            var zTreeTools = {
                ...
                removeNode : function(node, callbackFlag) {
                    ...
                    //if(typeof setting.callback.beforeRemove == 'function') {return false;}
